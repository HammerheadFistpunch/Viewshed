...
- [2.2.1 Release Notes](docs/RELEASE_NOTES_2.2.1.md)
...
The release version is stored in `VERSION`. GitHub Actions reads that value, packages it with the executable, and names the downloadable artifact `Signal-Peak-Windows-2.2.1` for the current release.
